 ...
 */
bool testAddContainElement(void) {

  PrimitiveBloomFilter<double, 1000> bloomFilter(100);

  // empty bloom filter should not contain anything
  if (bloomFilter.containsElement(12.1) || bloomFilter.containsElement(0) ||
